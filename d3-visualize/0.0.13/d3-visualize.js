// d3-visualize Version 0.0.13. Copyright 2017 quantmind.com.
...
}(this, (function (exports,assign,d3Array,d3Random,d3Collection,d3Let,d3View,d3Dsv,d3Dispatch,crossfilter,d3TimeFormat,d3Format,d3Selection,d3Transition,d3_scale,d3_legend,d3_shape) { 'use strict';
...
function legendName(name) {
    if (name.substring(0, 6) !== 'legend') name = 'legend' + name[0].toUpperCase() + name.substring(1);
    return name;
}

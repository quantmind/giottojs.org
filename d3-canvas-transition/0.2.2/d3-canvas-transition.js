...
}(this, (function (exports,d3Transition,d3Collection,d3Timer,d3Color,d3Selection) { 'use strict';
...
function select$1(selector$$1, deque$$1, selections) {
    ...
    for (var s = 0; s < selectors.length; ++s) {
        ...
        if (selector$$1.indexOf('#') > -1) {
            bits = selector$$1.split('#');
            tag = bits[0];
            id = bits[1];
        } else if (selector$$1.indexOf('.') > -1) {
            bits = selector$$1.split('.');
            tag = bits[0];

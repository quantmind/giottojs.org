// https://github.com/quantmind/d3-let Version 0.4.0. Copyright 2018 Luca Sbardella.
...
var logger = inBrowser ? window.console : console;
...
function promise (result) {
       return new Promise(function (resolve, reject) {
              if (isError(result)) reject(result);else resolve(result);
       });
}
...
exports.resolvedPromise = promise;

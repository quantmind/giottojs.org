// d3-view Version 0.3.0. Copyright 2017 quantmind.com.
...
//
// prototype for views
var protoView = d3Let.assign({}, protoComponent, {
...
var validators = {
    ...
    set: function set$$1(vm, el) {
        ...
        vm.model.$on(function (property) {
            return _this.validate(property, vm);
        });
    },
    validate: function validate(property, vm) {

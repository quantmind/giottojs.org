// d3-visualize Version 0.3.5. Copyright 2017 quantmind.com.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-let'), require('d3-array'), require('d3-random'), require('d3-collection'), require('d3-view'), require('d3-dsv'), require('crossfilter'), require('d3-dispatch'), require('d3-time-format'), require('d3-selection'), require('d3-transition'), require('d3-scale'), require('d3-format'), require('d3-axis'), require('d3-shape'), require('d3-color'), require('d3-svg-legend'), require('d3-brush')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-let', 'd3-array', 'd3-random', 'd3-collection', 'd3-view', 'd3-dsv', 'crossfilter', 'd3-dispatch', 'd3-time-format', 'd3-selection', 'd3-transition', 'd3-scale', 'd3-format', 'd3-axis', 'd3-shape', 'd3-color', 'd3-svg-legend', 'd3-brush'], factory) :
	(factory((global.d3 = global.d3 || {}),global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.crossfilter,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3));
}(this, (function (exports,d3Let,d3Array,d3Random,d3Collection,d3View,d3Dsv,crossfilter,d3Dispatch,d3TimeFormat,d3Selection,d3Transition,d3_scale,d3Format,d3Axis,d3Shape,d3Color,d3SvgLegend,d3Brush) { 'use strict';
...
var grouper = function () {
    ...
    grouper.stack = function (_) {
        return arguments.length ? (stack = _, grouper) : stack$$1;
    };
...
//
//  A chart displaying a geographical map
var geo2 = createChart('geochart2', {
    // load these libraries - add 'leaflet'?
    requires: ['d3-geo', 'topojson', 'd3-geo-projection'],
...
exports.Svg = Svg;
exports.Div = Div;
exports.visualTransform = transformFactory;

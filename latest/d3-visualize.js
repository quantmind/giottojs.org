...
(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['exports', 'object-assign', 'd3-array', 'd3-random', 'd3-collection', 'd3-let', 'd3-dsv', 'd3-view', 'd3-dispatch', 'crossfilter', 'd3-format', 'd3-time-format', 'd3-canvas-transition', 'd3-require', 'd3-selection'], factory) :
	(factory((global.d3 = {}),global.assign,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.crossfilter,global.d3,global.d3,global.d3,global.d3,global.d3));
}(this, (function (exports,assign,d3Array,d3Random,d3Collection,d3Let,d3Dsv,d3View,d3Dispatch,crossfilter,d3Format,d3TimeFormat,d3CanvasTransition,d3Require,d3Selection) { 'use strict';
...
function elementWidth(el) {
    var w = el.getBoundingClientRect()['width'],
        s = d3CanvasTransition.select(el),
...
var liveVisuals = [];
var visualTypes = {};
var visualEvents = d3Dispatch.dispatch('init', 'before-draw', 'after-draw');
...
var visualPrototype = assign({}, {
    ...
    select: function select$$1(el) {
        return d3CanvasTransition.select(el);
    },
...
function RootElement(element, options) {
    ...
    Object.defineProperties(this, {
        ...
        sel: {
            get: function get() {
                return d3CanvasTransition.select(element);
            }
        },
        size: {
            get: function get() {
...
var Visual = createVisual('visual', {
    initialise: function initialise(options, element) {
        if (!options.group) options.group = new visualTypes.group(options, element);

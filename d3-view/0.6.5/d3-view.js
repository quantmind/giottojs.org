// d3-view Version 0.6.5. Copyright 2017 quantmind.com.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-collection'), require('d3-let'), require('d3-selection'), require('object-assign'), require('d3-timer'), require('d3-dispatch'), require('d3-require')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-collection', 'd3-let', 'd3-selection', 'object-assign', 'd3-timer', 'd3-dispatch', 'd3-require'], factory) :
	(factory((global.d3 = global.d3 || {}),global.d3,global.d3,global.d3,global.assign,global.d3,global.d3,global.d3));
}(this, (function (exports,d3Collection,d3Let,d3Selection,assign,d3Timer,d3Dispatch,d3Require) { 'use strict';
...
var on = {
    ...
    mount: function mount(model) {
        ...
        this.sel.on(eventName + '.' + this.uid, function () {
            model.$event = d3Selection.event;
            try {
                expr.eval(model);
            } finally {
                delete model.$event;
...
var $change = function (attribute) {
    ...
    if (event$$1) event$$1.trigger.apply(this, args);else warn('attribute \'' + name + '\' is not a reactive property this model');
    return this;
};
...
var protoComponent = assign({}, base$1, {
    //
    // hooks
    ...
    mountInner: function mountInner(sel$$1, inner) {
        var el = sel$$1.node();
        sel$$1.html(inner);
        if (el.childNodes.length) {
            var children = slice(el.childNodes);
            var p = sel$$1.view(this).selectAll(function () {
                return children;
            }).mount();
...
//
// prototype for views
var protoView = assign({}, protoComponent, {

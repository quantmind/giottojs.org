// d3-visualize Version 0.2.9. Copyright 2017 quantmind.com.
(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['exports', 'object-assign', 'd3-array', 'd3-random', 'd3-collection', 'd3-let', 'd3-view', 'd3-dsv', 'd3-dispatch', 'crossfilter', 'd3-time-format', 'd3-selection', 'd3-transition', 'd3-scale', 'd3-format', 'd3-axis', 'd3-shape', 'd3-color', 'd3-svg-legend', 'd3-brush'], factory) :
	(factory((global.d3 = global.d3 || {}),global.assign,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.crossfilter,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.d3));
}(this, (function (exports,assign,d3Array,d3Random,d3Collection,d3Let,d3View,d3Dsv,d3Dispatch,crossfilter,d3TimeFormat,d3Selection,d3Transition,d3_scale,d3Format,d3Axis,d3Shape,d3Color,d3SvgLegend,d3Brush) { 'use strict';
...
function tooltip() {
    ...
    tooltip.show = function (target) {
        ...
        snode.classed(dir, true).style('top', coords.top + poffset[1] + scrollTop + 'px').style('left', coords.left + poffset[0] + scrollLeft + 'px');

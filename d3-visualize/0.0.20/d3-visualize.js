// d3-visualize Version 0.0.20. Copyright 2017 quantmind.com.
    ...
    draw: function draw() {
        ...
        this.layers.forEach(function (visual) {
            try {
                ...
                warn$1('Could not draw ' + visual.toString() + ': ' + e);
            }
        });
...
vizPrototype.colors = function (n) {
    ...
    return d3Array.range(0, Math.min(n, points)).map(function (v) {
        return scale(v);
    });
};

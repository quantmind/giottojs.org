// d3-view Version 0.5.2. Copyright 2017 quantmind.com.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-collection'), require('d3-let'), require('d3-selection'), require('d3-timer'), require('d3-dispatch')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-collection', 'd3-let', 'd3-selection', 'd3-timer', 'd3-dispatch'], factory) :
	(factory((global.d3 = global.d3 || {}),global.d3,global.d3,global.d3,global.d3,global.d3));
}(this, (function (exports,d3Collection,d3Let,d3Selection,d3Timer,d3Dispatch) { 'use strict';
    ...
    refresh: function refresh(model, html) {
        ...
        if (d3Let.isString(html)) {
            ...
            for (var i = 0; i < children.length; ++i) {
                d3Selection.select(children[i]).mount();
            }
        }
    }
};
...
function createValueType(proto) {
    ...
    ValueType.prototype = objectAssign$1({}, base, proto);
...
var base$1 = {
    ...
    renderFromUrl: function renderFromUrl(url, context) {
        ...
        if (url in cache) return new Promise(function (resolve) {
            return resolve(asElement ? htmlElement(cache[url]) : cache[url]);
        });
...
function reactive(model, key, value) {
    ...
    value = isObject$1(value) ? model.$new(value) : value;
    ...
    function update(newValue) {
        ...
        var oldValue = value;
        value = isObject$1(newValue) ? model.$new(newValue) : newValue;
        //
        // Fire model events
    ...
    function property() {
        ...
        if (isObject$1(value) && d3Let.isFunction(value.get)) {
            lazy = value;
...
var $change = function (attribute) {
    ...
    if (event$$1) (_event$trigger = event$$1.trigger).call.apply(_event$trigger, [this].concat(toConsumableArray(args)));else warn('attribute \'' + name + '\' is not a reactive property this model');
    return this;
};
...
//  * destroy
//
var prototype = objectAssign$1({}, base$1, {
    priority: 1,
...
var createDirective = function (obj) {
    ...
    Directive.prototype = objectAssign$1({}, prototype, obj);
...
function addTarget(modelEvents, model$$1, attr) {
    ...
    //
    if (d3Let.isFunction(value) || arguments.length === 2) target.events.add('');else if (value instanceof model) {
        target.events.add('');
        addTarget(modelEvents, value);
    } else target.events.add(attr);
}
...
var protoComponent = objectAssign$1({}, base$1, {
    //
    // hooks
    init: function init() {},
    ...
    mount: function mount(el, data, onMounted) {
        if (mounted(this)) warn('already mounted');else {
            ...
            data = objectAssign$1({}, sel$$1.datum(), data);

            // override model keys from data object and element attributes
            for (key in model) {
                target = data[key] === undefined ? dattrs : data;
                if (target[key] !== undefined) model[key] = maybeJson(d3Let.pop(target, key));
            }
            ...
            } else return compile(this, el, newEl, onMounted);
        }
    }
});
...
function createComponent(name, o, prototype, coreDirectives) {
    ...
    function Component(options) {
        ...
        this.model = objectAssign$1({}, d3Let.isFunction(model) ? model() : model, d3Let.pop(options, 'model'));
        this.init(options);
    }

    Component.prototype = objectAssign$1({}, prototype, obj);
...
function asView(vm, element, onMounted) {
    ...
    if (d3Let.isPromise(p)) return p.then(function () {
        vm.mounted();
...
function mountElement(element, vm, data, onMounted) {
    ...
    if (preMount) return preMount.execute(vm.model);else {
        ...
        if (d3Let.isPromise(promise)) return promise.then(function () {
...
//
// prototype for views
var protoView = objectAssign$1({}, protoComponent, {
...
var main = createComponent('view', null, protoView, coreDirectives);
...
var field = objectAssign$1({}, formElement, {
...
//
// Fieldset element
var fieldset = objectAssign$1({}, formElement, {
...
//
// Input element
var input$1 = objectAssign$1({}, field, {
    render: function render(data) {
...
//
// Textarea element
var textarea = objectAssign$1({}, field, {
...
//
// Select element
var select$2 = objectAssign$1({}, field, {

    model: objectAssign$1({
        options: [],
...
//
// Submit element
var submit = objectAssign$1({}, formElement, {
...
function submit$1(e) {
    var submit = this,
        form = submit.form,
        endpoint = objectAssign$1({}, endpointDefauls, submit.endpoint);
...
var formGroup = function (field, wrappedEl, fieldEl) {
    var data = field.model.data;
    fieldEl.classed('form-control', true).attr('d3-class', '[' + (data.required || false) + ' ? "form-control-required" : null, showError ? "form-control-danger" : null]');

// https://github.com/quantmind/d3-quant Version 0.4.3. Copyright 2017 quantmind.com.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-let'), require('d3-random')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-array', 'd3-let', 'd3-random'], factory) :
	(factory((global.d3 = {}),global.d3,global.d3Let,global.d3Random));
}(this, (function (exports,d3Array,d3Let,d3Random) { 'use strict';
...
var newton = function (f, fprime, guess, options) {
    options = options || {};
    var tolerance = options.tolerance || defaults$1.tolerance,
        epsilon = options.epsilon || defaults$1.epsilon,
        maxIterations = options.maxIterations || defaults$1.maxIterations,
        result = guess,
        denominator = void 0;
...
Amortization.prototype = amortisation.prototype = {
    ...
    interest: function interest(amount) {
...
function discount(am) {
    ...
    return function (x, schedule) {
        ...
        for (var period = 1; period <= am.term; ++period) {
            if (period > am.deferred) remaining += deferredInterest;

            interest = am.interest(remaining);

            if (period > am.deferred) principal = x - interest;else {
...
var randompath = function (size, options) {
    options = d3Let.assign({}, defaults$2, options);
...
exports.amortisation = amortisation;

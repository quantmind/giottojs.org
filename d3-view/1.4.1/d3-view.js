...
(function (global, factory) {
    ...
    const isModel = value => d3Let.isObject(value) && value.toString() === '[object d3Model]';
    ...
    const protoComponent = {
        ...
        mount (el, data) {
            ...
            else if(this.parent && this.parent.props[extra]) props = d3Let.assign({}, this.parent.props[extra], props);
    ...
    var main = config => createComponent('view', protoView, coreDirectives)(config);

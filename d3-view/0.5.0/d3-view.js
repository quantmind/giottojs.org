// d3-view Version 0.5.0. Copyright 2017 quantmind.com.
...
function createValueType(proto) {
    ...
    ValueType.prototype = index$1({}, base, proto);
...
var protoComponent = index$1({}, base$1, {
    isd3: true,
    providers: providers,
    ...
    renderFromUrl: function renderFromUrl(url, context) {
        ...
        if (url in cache) return new Promise(function (resolve) {
            return resolve(htmlElement(cache[url]));
        });
    ...
    mount: function mount(el, data, onMounted) {
        if (mounted(this)) warn('already mounted');else {
            ...
            for (key in model) {
                ...
                if (value !== undefined) model[key] = maybeJson(pop(data, key));
            }
...
var mount$1 = function (el, html, data) {
    var p = d3Selection.select(el).html(html).mount(data);
...
//
// Fieldset element
var fieldset = index$1({}, formElement, {
...
//
// Submit element
var submit = index$1({}, formElement, {
...
function submit$1(e) {
    var submit = this,
        form = submit.form,
        endpoint = index$1({}, endpointDefauls, submit.endpoint);

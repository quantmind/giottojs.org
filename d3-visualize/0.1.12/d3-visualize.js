// d3-visualize Version 0.1.12. Copyright 2017 quantmind.com.
    ...
    doDraw: function doDraw(frame) {
        ...
        if (model.orientation === 'vertical') {
            if (model.axisX) {
                ...
                paper.group('x-axis').attr("transform", this.translate(box.total.left, box.total.top + box.innerHeight)).call(axis);
            }

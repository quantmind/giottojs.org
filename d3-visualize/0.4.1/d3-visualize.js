// d3-visualize Version 0.4.1. Copyright 2017 quantmind.com.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-let'), require('d3-collection'), require('d3-view'), require('d3-dsv'), require('d3-dispatch'), require('d3-array'), require('d3-time-format'), require('d3-transition'), require('d3-selection'), require('d3-format'), require('d3-color')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-let', 'd3-collection', 'd3-view', 'd3-dsv', 'd3-dispatch', 'd3-array', 'd3-time-format', 'd3-transition', 'd3-selection', 'd3-format', 'd3-color'], factory) :
...
}(this, (function (exports,d3Let,d3Collection,d3View,d3Dsv,d3Dispatch,d3Array,d3TimeFormat,d3Transition,d3Selection,d3Format,d3Color) { 'use strict';
...
function requireFrom(source) {
  ...
  function require(name) {
    return arguments.length > 1 ? Promise.all(map$1.call(arguments, load)).then(merge) : load(name);
  }

// d3-view Version 0.9.4. Copyright 2017 quantmind.com.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-collection'), require('d3-let'), require('d3-timer'), require('d3-selection'), require('d3-dispatch'), require('d3-require')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-collection', 'd3-let', 'd3-timer', 'd3-selection', 'd3-dispatch', 'd3-require'], factory) :
	(factory((global.d3 = global.d3 || {}),global.d3,global.d3,global.d3,global.d3,global.d3,global.d3));
}(this, (function (exports,d3Collection,d3Let,d3Timer,d3Selection,d3Dispatch,d3Require) { 'use strict';
...
var base$1 = d3Let.assign(base$2, {
    //
...
var createDirective = function (obj) {
    ...
    Directive.prototype = d3Let.assign({}, base$1, prototype, obj);
...
var properties$1 = ['readonly', 'required', 'disabled'];
...
var formElement = {
    inputData: function inputData(el, data) {
        ...
        properties$1.forEach(function (prop) {
            var value = data[prop];
            if (value) {
                if (d3Let.isString(value)) el.attr('d3-attr-' + prop, value);else el.property('disabled', true);
            }
        });
        return data;
    },
